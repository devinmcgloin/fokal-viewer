  ...
  <article className="sans-serif cf mw9 center">
    <header className="w-100 pa3 pa4-m pa5-l mb3 mb5-l mw7 center">
      <h1 className="f2 fw9 f1-l lh-title b mt0 tc">
        Fokal helps you find images you&#39;ll love and get your own images
        seen.
      </h1>
      <h2 className="f5 fw5 lh-title tc">
        We use cutting edge machine intelligence in order to make sure your best
        images rise to the top and help you find the images that you&#39;re
        looking for.
      </h2>
    </header>
    <section className="fl w-100 bg-white">
      <SmallFeature
        ...
        body={
          <span>
            Fokal makes complicated search queries easy. We use best in class
            machine learning and image recognition to analyze your queries and
            match them the relevant images. All content is uploaded with the
            permissive Unsplash Liscence, allowing you to use the images you
      ...
      <SmallFeature
        ...
        body={
          <span>
            Each Image can be found in relation to the place it was taken. You
            can search for{' '}
            <Link
              className="link dim"
            ...
            </Link>. If you&#39;re planning a road trip, or traveling you can
            get images from a specific region and decide what places to spend
            your time. It also means you can search for images from a specific
            small town or national park.
          </span>
        }
      />
      ...
      <SmallFeature
        ...
        body={
          <span>
            In addition to search based on geography, it&#39;s also possible to
            search based on color. For example{' '}
            <Link className="link dim" to="/search?q=cars%20rgb(200,200,0)">
              Cars rgb(200, 200, 0)
            </Link>{' '}
            shows images of yellow cars. For any given image you can also view
            the color components, allowing color pallates to be generated from
            an image.
          </span>
        }
      />
      <SmallFeature
        ...
        body={
          <span>
            Fokal operates off an extensible API. Allowing developers to build
            off Fokal&#39;s advanced image tagging and searching. This allows
            custom domains and more advanced features to be implemented quicker.
            The code for Fokal is opensource, and welcomes pull requests.
          </span>
        }
      />
    </section>
    <Feature
      ...
      body={
        <span>
          We&#39;re frustrated by the hundreds of good photos sitting in your
          archives that only friends and family have seen. With Fokal, those
          images have a higher chance of being seen than other platforms. Our
          specific search allows local winner photographs to be found.
        </span>
      }
    />
    <Feature
      ...
      body={
        <span>
          Our balance between machine curation and human tagging, as well as an
          emphasis on metadata means you can find the photo you&#39;re looking
          for. Fokal handles queries complex like{' '}
          <span className="b">cafes in Paris </span> or{' '}
          <span className="b">London skyline</span> as you would expect. The
    ...
    <section className="w-100">
      ...
      <div className="fl w-100 tc pa6-ns pa3">
        <p className="lh-copy relative z-1">
          Join to collect images, post your own or find your next travel
          destination.
        </p>
