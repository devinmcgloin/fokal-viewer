    ...
    <article className="sans-serif cf mw9 center">
        <header className="w-100 pa3 pa4-m pa5-l mb3 mb5-l mw7 center">
            <h1 className="f2 fw9 f1-l lh-title b mt0 tc">
                Fokal helps you find images you&#39;ll love and get your own
                images seen.
            </h1>
            <h2 className="f5 fw5 lh-title tc">
                We use cutting edge machine intelligence in order to make sure
                your best images rise to the top and help you find the images
