...
const InfoAlert = ({ message, active }) => (
  <Alert message={message} active={active} action="Dismiss" title="Info" actionColor={'#3554f2'} />
);
...
const ErrorAlert = ({ message, active }) => (
  <Alert message={message} active={active} action="Dismiss" title="Error" actionColor={'#f44336'} />
);
