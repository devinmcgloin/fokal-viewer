...
const Metadata = ({
  ...
  <article className="cf sans-serif center w-80">
    <div className="fl w-100 w-33-ns pa3 tc">
      ...
      <dd className="f3 fw6 ml0">{aperture ? 'f/' + Math.round(aperture * 100) / 100 : '--'}</dd>
    </div>
    <div className="fl w-100 w-33-ns pa3 tc">
      <dd className="f6 fw4 ml0">Expsure Time</dd>
      <dd className="f3 fw6 ml0">{exposure_time ? exposure_time + 's' : '--'}</dd>
    </div>
    <div className="fl w-100 w-33-ns pa3 tc">
      <dd className="f6 fw4 ml0">Focal Length</dd>
      <dd className="f3 fw6 ml0">{focal_length ? focal_length + 'mm' : '--'}</dd>
    </div>
    <div className="fl w-100 w-33-ns pa3 tc">
    ...
    <div className="fl w-100 w-33-ns pa3 tc">
      ...
      <dd className="f3 fw6 ml0">{capture_time ? moment(capture_time).format('LL') : '--'}</dd>
    </div>
    <div className="fl w-100 w-33-ns pa3 tc">
      <dd className="f6 fw4 ml0">Camera</dd>
      <dd className="f3 fw6 ml0">{!make && !model ? '--' : [make, model].join(' ')}</dd>
    </div>
  </article>
);
