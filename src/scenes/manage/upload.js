...
class ImageModify extends Component {
    ...
    render() {
        ...
        if (this.state.progress === 0)
            stage = (
                <Exif onSubmit={this.handleSubmit} buttonValue="Next" image={this.state.image} />
            );
        else if (this.state.progress === 1)
            stage = (
                <Tags onSubmit={this.handleSubmit} buttonValue="Next" image={this.state.image} />
            );
        else if (this.state.progress === 2)
            stage = (
                <Gear onSubmit={this.handleSubmit} buttonValue="Next" image={this.state.image} />
            );
        else if (this.state.progress === 3)
            stage = (
                <Geo onSubmit={this.handleSubmit} buttonValue="Done" image={this.state.image} />
            );
        else
            stage = (
                <div className="pa3">
