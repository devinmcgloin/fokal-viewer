...
const FetchMe = () => {
    return fetch(endpoint + '/users/me', { headers: getHeaders() }).then(ParseResponse);
};
...
export { FetchImages, FetchImage, FetchMe, FetchUser, FetchUserImages, IncrementDownloads };
